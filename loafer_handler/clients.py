...
package_canceled_topic_arn = (
    f"arn:aws:sns:us-east-1:000000000000:{settings.PACKAGE_CANCELED_TOPIC_NAME}"
)
...
class SNSClient:
    ...
    def publish_message(self, payload: Any):
        ...
        client.publish(TopicArn=self.topic_arn, Message=json.dumps(payload))
